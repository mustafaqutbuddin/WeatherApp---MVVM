...
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified unitSegmentedControl;
- (void)viewDidLoad;
- (IBAction)searchPressed:(UIButton * _Nonnull)sender;
- (IBAction)onUnitChanged:(UISegmentedControl * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


@interface WeatherViewController (SWIFT_EXTENSION(WeatherApp)) <UITextFieldDelegate>
...
@interface WeatherViewController (SWIFT_EXTENSION(WeatherApp)) <CLLocationManagerDelegate>
- (IBAction)currentLocationPressed:(UIButton * _Nonnull)sender;
